...
const HeroSection = () => {
  return (
    <section style={{ backgroundColor: 'rgb(0, 167, 231)' }} className="pt-20 pb-20 overflow-hidden">
          ...
          <div className="space-y-6 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a href="https://wa.me/5571992443407" target="_blank" rel="noopener noreferrer">
                <Button size="lg" style={{ backgroundColor: '#8FC78F'}} className="hover:opacity-90 font-semibold">
                  Falar com um consultor
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </a>
              <a href="https://wa.me/5571992443407" target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-white/10 text-white border-2 border-white hover:bg-[#8FC78F] hover:border-[#8FC78F]">
